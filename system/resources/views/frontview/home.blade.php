                            ...
                            <ul class="top-menu">
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="#signin-modal" data-toggle="modal">Login
                                        </a></li>
                                    </ul>
                                </li>
                            </ul><!-- End .top-menu -->
                            ...
                            <div class="tab-pane p-0 fade" id="products-new-tab" role="tabpanel" aria-labelledby="products-new-link">
                                <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                    ...
                                    <div class="product">
                                        <figure class="product-media">
                                            <a href="{{ url('product') }}">
                                                <img src="{{ url('public') }}/assets/images/demos/demo-19/products/product-6.jpg" alt="Product image" class="product-image">
                                            </a>
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="{{ url('product') }}">Tom Clancy’s <br>Ghost Recon Wildlands</a></h3><!-- End .product-title -->
                                            <div class="product-price">
                                                $49.99
                                            </div><!-- End .product-price -->
                                        </div><!-- End .product-body -->
                                    ...
                                    <div class="product">
                                        <figure class="product-media">
                                            ...
                                            <a href="{{ url('product') }}">
                                                <img src="{{ url('public') }}/assets/images/demos/demo-19/products/product-5.jpg" alt="Product image" class="product-image">
                                            </a>
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="{{ url('product') }}">GTA Online: Criminal Enterprise Starter Pack</a></h3><!-- End .product-title -->
                                            <div class="product-price">
                                    ...
                                    <div class="product">
                                        <figure class="product-media">
                                            <a href="{{ url('product') }}">
                                                <img src="{{ url('public') }}/assets/images/demos/demo-19/products/product-2.jpg" alt="Product image" class="product-image">
                                            </a>
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="{{ url('product') }}">World War Z</a></h3><!-- End .product-title -->
                                            <div class="product-price">
                                                $39.99
                                            </div><!-- End .product-price -->
                                        </div><!-- End .product-body -->
                                    ...
                                    <div class="product">
                                        <figure class="product-media">
                                            <span class="product-label label-sale">Sale</span>
                                            <a href="{{ url('product') }}">
                                                <img src="{{ url('public') }}/assets/images/demos/demo-19/products/product-1.jpg" alt="Product image" class="product-image">
                                            </a>
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="{{ url('product') }}">Call of Duty <br>WWII - Gold Edition</a></h3><!-- End .product-title -->
                                            <div class="product-price">
                                    ...
                                    <div class="product">
                                        <figure class="product-media">
                                            <span class="product-label label-top">Top</span>
                                            <a href="{{ url('product') }}">
                                                <img src="{{ url('public') }}/assets/images/demos/demo-19/products/product-3.jpg" alt="Product image" class="product-image">
                                            </a>
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="{{ url('product') }}">Borderlands: <br>The Handsome Collection</a></h3><!-- End .product-title -->
                                            <div class="product-price">
                                                $59.99
                                            </div><!-- End .product-price -->
                                        </div><!-- End .product-body -->
                                    ...
                                    <div class="product">
                                        <figure class="product-media">
                                            <a href="{{ url('product') }}">
                                                <img src="{{ url('public') }}/assets/images/demos/demo-19/products/product-4.jpg" alt="Product image" class="product-image">
                                            </a>
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="{{ url('product') }}">The Witcher 3: Wild Hunt</a></h3><!-- End .product-title -->
                                            <div class="product-price">
                                                $39.99
                                            </div><!-- End .product-price -->
                                        </div><!-- End .product-body -->
